...
instance ToJSON SrcSpan where 
    toJSON (SrcSpan f fromL fromC toL toC) = object [
...
instance ToJSON SrcLoc where
    toJSON (SrcLoc f line col) = object [
